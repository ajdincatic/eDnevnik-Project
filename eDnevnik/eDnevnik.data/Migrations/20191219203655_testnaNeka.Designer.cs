...
namespace eDnevnik.data.Migrations
{
    ...
    [Migration("20191219203655_testnaNeka")]
    partial class testnaNeka
    {
            ...
            modelBuilder.Entity("SeminarskiRS1.Model.Odjeljenje", b =>
                {
                    ...
                    b.Property<int?>("PredsjednikUceniciID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PredsjednikUceniciID");
            ...
            modelBuilder.Entity("SeminarskiRS1.Model.Odjeljenje", b =>
                {
                    ...
                    b.HasOne("SeminarskiRS1.Model.Ucenici", "Predsjednik")
                        .WithMany()
                        .HasForeignKey("PredsjednikUceniciID");
